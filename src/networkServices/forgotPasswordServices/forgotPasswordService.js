...
const userEmailVerificationService = async email => {
  try {
    const url = urlConstants.BaseUrl + urlConstants.userEmailVerification + email;
    const headersParams = {};
    headersParams['Content-Type'] = 'application/json';
    console.log('useremail verfication service url ...', url);
    console.log('useremail verfication service headersParams ...', headersParams);
...
export {userEmailVerificationService};
